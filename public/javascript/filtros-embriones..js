...
boton_edad.addEventListener("click", function (e) {
    e.preventDefault;
    location.href = "/genetica/embriones/?min_ed=" + sliderDesde_edad.value + "&max_ed=" + sliderHasta_edad.value;
    console.log("Hola");
});

borrar_edad.addEventListener("click", function (e) {
    e.preventDefault;
    location.href = "/genetica/embriones";
});
...
boton.addEventListener("click", function (e) {
    e.preventDefault;
    location.href = "/genetica/embriones/?min=" + sliderDesde.value + "&max=" + sliderHasta.value;
    console.log("Hola");
});
