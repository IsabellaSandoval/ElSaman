...
boton_edad.addEventListener("click", function (e) {
    e.preventDefault;
    location.href = "/genetica/novillas/?min_ed=" + sliderDesde_edad.value + "&max_ed=" + sliderHasta_edad.value;
    console.log("Hola");
});
...
boton.addEventListener("click", function (e) {
    e.preventDefault;
    location.href = "/genetica/novillas/?min=" + sliderDesde.value + "&max=" + sliderHasta.value;
    console.log("Hola");
});
